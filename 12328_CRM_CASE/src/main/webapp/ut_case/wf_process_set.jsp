...
<body>
    ...
    <div id="divBody" align="center">
         ...
         <div id="divHandle">
            <div id="plHandle"  style="width:100%;"><br />
             <div id="plRecv"  style="display:block" >
                 <fieldset style="height:auto; width:80%; text-align:centert; border: 1px solid Silver;">
                    <legend style="text-align: left; font-size:11pt;width:auto;">接收来件</legend>
           	          <table  width="50%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left">               
                                 <input id="btnAccept" name="btnAccept" value=" 签收 " onclick="return myToorBar_btnItemClick('Accept');" class="wfcmd_btnStyle_dis" type="submit">      
                            </td>
                            <td align="left">
                                <input id="btnRefuse" name="btnRefuse" value=" 拒收 " onclick="return myToorBar_btnItemClick('Refuse');" class="wfcmd_btnStyle_dis" type="submit">      
                            </td>
                        </tr>  
                    </table>
                 </fieldset>
             </div>     
             <div id="plSend"  style="display:block" >
                 <fieldset style="height:auto; width:80%; text-align:centert; border: 1px solid Silver;">
                    <legend style="text-align: left;font-size:11pt;width:auto;">转出来件</legend>
                       <div id="plSubmit"   >
                       ...
                       <div id="plUpdate"  style="display:block">
           	              <table  width="80%" border="0" cellpadding="0" cellspacing="0">
                            <tr valign="top">
                                <td align="left" style="width:120px;">               
                                   ...
                                   <input id="btnComplete" name="btnComplete" value=" 完成 " onclick="return myToorBar_btnItemClick('Complete');" class="wfcmd_btnStyle_dis" type="submit">      
                               </td>
                                <td align="left">
                                    ${txtExpDate} &nbsp;超时日期&nbsp;&nbsp;
                                    ${cboUpdateGhid}&nbsp;接收人
  	     ...
  	     <div id="prompt_msg" style="color:#3366CC;margin-top:10px;" ><span id="lblRem">${lblRem }</span></div>
    </div>
    </form>
</body>
</html>
