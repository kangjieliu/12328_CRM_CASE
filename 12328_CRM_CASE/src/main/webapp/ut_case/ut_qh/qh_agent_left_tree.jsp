...
<script type="text/javascript" language="javascript">
	$(document)
			.ready(
					function() {
						var pOrg_code = fun_querystring("pOrg_code");
						
						var strUrl = rootURL
								+ "/ut_case/ut_qh/qh_agent_left_tree_print.aspx?pOrg_code="+pOrg_code;
	...
	function TreeView_PopulateNode(nodeId) {
		var strUrl = rootURL
				+ "/ut_case/ut_qh/qh_agent_left_tree_print.aspx?strNodeId="
				+ nodeId;
		$('#' + nodeId).load(strUrl);
	}
</script>
